...
<header class="header">
   ...
   <a href="Home.php" ><i class="fa-solid fa-house"></i></a> 
      <a href="#" class="logo">fouziya shopping zone</a>
...
<form method="post" action="" >
 ...
 <input type="submit"  value="kids wear" name="category" >
 <input type="submit"  value="mens wear" name="category2" >
 <input type="submit"  value="gowns" name="category3" >
 <input type="submit"  value="tops" name="category4" >
 <input type="submit"  value="lehenga" name="category5" >
 <input type="submit"  value="sarees" name="category6" >
